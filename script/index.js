...
if (window.innerHeight / window.innerWidth > 1.4) {
  videos[0].src = "videos/Mobile Vertikal.mp4";
  videosRev[0].src = "videos/Mobile Vertikal Nazad.mp4";
  ...
  videos[0].src = "videos/Desctop.mp4";
  videosRev[0].src = "videos/Desctop Nazad.mp4";
}
...
for (const navItem of navItems) {
  navItem.addEventListener("click", () => {
    if (!triger) {
      ...
      textTenTwo[1].classList.remove("fade-in-text-ten-two");
...
navItems[3].addEventListener("click", () => {
  if (!triger) {
    ...
    setTimeout(() => {
      text[20].classList.add("fade-in-text");
    }, 10300);
    setTimeout(() => {
...
navItems[5].addEventListener("click", () => {
  if (!triger) {
    ...
    setTimeout(() => {
      text[21].classList.add("fade-in-text");
    }, 5700);
    setTimeout(() => {
      text[22].classList.add("fade-in-text");
    }, 6000);
    setTimeout(() => {
      text[23].classList.add("fade-in-text");
    }, 6300);
    setTimeout(() => {
...
navItems[7].addEventListener("click", () => {
  if (!triger) {
    ...
    setTimeout(() => {
      text[24].classList.add("fade-in-text");
    }, 6700);
    setTimeout(() => {
      text[25].classList.add("fade-in-text");
    }, 7000);
    setTimeout(() => {
      text[26].classList.add("fade-in-text");
    }, 7300);
    setTimeout(() => {
...
//isr-can-mob-logo
let isrCanMobLogo = document.getElementsByClassName(
  "isr-can-logo-container-mob"
);
// isrCanMobLogo[0].style.opacity = 1;
...
function setDisplayCounter(scrollSectionDisplay, counterLine, counterLineNum) {
  ...
  if (scrollSectionDisplay > 1) {
    ...
    isrCanMobLogo[0].style.opacity = 0;
  }
...
function videoForvard() {
  ...
  if (scrollSection == 8 && !triger) {
    ...
    setTimeout(() => {
      ...
      text[20].classList.remove("fade-in-text");
  ...
  if (scrollSection == 9 && !triger) {
    ...
    setTimeout(() => {
      ...
      text[21].classList.remove("fade-in-text");
      text[22].classList.remove("fade-in-text");
      text[23].classList.remove("fade-in-text");
  ...
  if (scrollSection == 10 && !triger) {
    ...
    setTimeout(() => {
      ...
      text[24].classList.remove("fade-in-text");
      text[25].classList.remove("fade-in-text");
      text[26].classList.remove("fade-in-text");
    ...
    setTimeout(() => {
      textTenTwo[1].classList.add("fade-in-text-ten-two");
    }, 5700);
    setTimeout(() => {
...
let intervalPlay = setInterval(() => {
  if (videos[0].currentTime > 0.01) {
    ...
    if (locationHref == "#customerexperience") {
      //start video
      setDisplayCounter(6, counterLine, 5);
      videos[0].currentTime = 36.2;
      scrollVideo(7, 41.5, 42.5, 42.5);
    ...
    if (locationHref == "#landscapingandgreenspaces") {
      //start video
      setDisplayCounter(7, counterLine, 6);
      videos[0].currentTime = 41.5;
      scrollVideo(8, 53.5, 54.5, 30.3);
    ...
    if (locationHref == "#suitabilityandrenewableenergy") {
      //start video
      setDisplayCounter(8, counterLine, 7);
      videos[0].currentTime = 53.5;
      scrollVideo(9, 61.5, 62.5, 23.2);
